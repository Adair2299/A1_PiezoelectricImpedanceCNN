...
# 加载数据
Imp1_500orgl = np.load('Imp1_500_RemoveWrongEMI.npy')  # (2496,108)
mass_loss_rateorgl = np.load('mass_loss_rate_RemoveWrongEMI.npy') # (108,1)
...
model_folder_name = f"初级CNN2-{current_time}"
